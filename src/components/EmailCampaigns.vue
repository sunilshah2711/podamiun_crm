<template>
  <div class="right-panel">
    <div class="email-heidng">
        <h1>Campaign : Admin Campaign</h1>
    </div>
    <TabGroup>
                    ...
                    <ul class="slds-tabs_default__nav">
                        <Tab class="left-tab-active"  v-slot="{ selected }">
                            <li class="slds-tabs_default__item" :class="[selected ? 'slds-is-active' : '']" title="Item One" role="presentation">
                                <a class="slds-tabs_default__link">Schedule</a>
                            </li>
                        </Tab>
                        <Tab class="left-tab-active"  v-slot="{ selected }">
                            <li class="slds-tabs_default__item" :class="[selected ? 'slds-is-active' : '']" title="Item Two" role="presentation">
                                <a class="slds-tabs_default__link">Sent</a>
                            </li>
                        </Tab>
                        <Tab class="left-tab-active" v-slot="{ selected }">
                            <li class="slds-tabs_default__item" :class="[selected ? 'slds-is-active' : '']" title="Item Three" role="presentation">
                                <a class="slds-tabs_default__link">Bounced</a>
                            </li>
                        </Tab>
                        <Tab class="left-tab-active"  v-slot="{ selected }">
                            <li class="slds-tabs_default__item" :class="[selected ? 'slds-is-active' : '']" title="Item One" role="presentation">
                                <a class="slds-tabs_default__link">Delivered</a>
                            </li>
                        </Tab>
                        <Tab class="left-tab-active"  v-slot="{ selected }">
                            <li class="slds-tabs_default__item" :class="[selected ? 'slds-is-active' : '']" title="Item Two" role="presentation">
                                <a class="slds-tabs_default__link">Open</a>
                            </li>
                        </Tab>
                        <Tab class="left-tab-active" v-slot="{ selected }">
                            <li class="slds-tabs_default__item" :class="[selected ? 'slds-is-active' : '']" title="Item Three" role="presentation">
                                <a class="slds-tabs_default__link">Click</a>
                            </li>
                        </Tab>
                    </ul>
                </TabList>
                        ...
                        <div class="data-email-main">
                            ...
                            <table class="slds-table slds-table_cell-buffer slds-table_bordered slds-table_col-bordered" aria-label="Example table of Opportunities with vertical borders">
                                <thead>
                                    ...
                                    <th class="" scope="col">
                                        <div class="slds-truncate" title="Close Date">Date 	&amp; Time</div>
                                    </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <td data-label="Account Name">
                                        <div class="slds-truncate" title="Cloudhub">user@support.com</div>
                                    </td>
                                    ...
                                    <td data-label="Account Name">
                                        <div class="slds-truncate" title="Cloudhub">admin@support.com</div>
                                    </td>
                                    <td data-label="Close Date">
                                        <div class="slds-truncate" title="4/14/2015">4/14/2015</div>
                                    </td>
