    ...
    >
      ...
      <tbody>
        <tr aria-selected="false" class="slds-hint-parent">
          ...
          <td class="slds-cell_action-mode" role="gridcell">
            <div class="slds-truncate" title="$25,000,000">
              <button
        ...
        <tr aria-selected="false" class="slds-hint-parent">
          ...
          <td class="slds-cell_action-mode" role="gridcell">
            <div class="slds-truncate" title="$5,000,000">
              <button
                class="slds-button slds-button_outline-brand"
                @click="isShowing2 = !isShowing2"
              >
        ...
        <tr aria-selected="false" class="slds-hint-parent">
          ...
          <td class="slds-cell_action-mode" role="gridcell">
            <div class="slds-truncate" title="salesforce.com">
              salesforce.com
            </div>
          </td>
          <td class="slds-cell_action-mode" role="gridcell">
            <div class="slds-truncate" title="1/31/15 3:45PM">
              1/31/15 3:45PM
            </div>
          </td>
          <td class="slds-cell_action-mode" role="gridcell">
            <div class="slds-truncate" title="Id. Decision Makers">
              Id. Decision Makers
            </div>
          </td>
          <td class="slds-cell_action-mode" role="gridcell">
          ...
          <td class="slds-cell_action-mode" role="gridcell">
            <div class="slds-truncate" title="$25,000">
              <button
                class="slds-button slds-button_outline-brand"
                @click="isShowing2 = !isShowin2"
              >
                View
              </button>
            </div>
      ...
      <div class="campaign-sidebar-right">
        ...
        <div class="campaign-body">
          ...
          <div class="campaign-input-wrap">
            <div class="slds-form-element">
              <label class="slds-form-element__label" for="text-input-id-47"
                >Send a test email</label
              >
              <div class="slds-form-element__control">
                <input
                  type="text"
                  id="text-input-id-47"
                  placeholder="Enter email by separated comma"
                  class="slds-input"
                />
              </div>
            </div>
    ...
    >
      <div class="campaign-sidebar-right">
        <div class="campaign-hedding">
          <div class="campaign-hedding-wrap">
            <h2>Email Campaign</h2>
            <button @click="isShowing2 = !isShowing2">
              <font-awesome-icon :icon="['fa', 'xmark']" />
            </button>
          </div>
        </div>
