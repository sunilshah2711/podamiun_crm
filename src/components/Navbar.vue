<template>
  <div class="slds-context-bar">
          ...
          >
            ...
            >
              <span class="slds-truncate" title="Menu Item"
                >Chat with Support</span
              >
            </a>
          </li>
        </router-link>
        <li
          class="slds-is-open slds-context-bar__item slds-context-bar__dropdown-trigger slds-dropdown-trigger slds-dropdown-trigger_click"
        >
          <Menu>
            <MenuButton
              class="slds-context-bar__label-action nav-dropdown-btn"
              title="Menu Item"
            >
              <span class="slds-truncate" title="Menu Item">More</span>
            </MenuButton>
    ...
    <div class="slds-context-bar__trenery">
      <ul class="slds-global-actions">
        <li class="slds-global-actions__item">
          <div class="slds-dropdown-trigger slds-dropdown-trigger_click">
            ...
            >
              ...
              >
                <use
                  xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#announcement"
                ></use>
              </svg>
        ...
        <li class="slds-global-actions__item">
          <div
            class="slds-is-open slds-dropdown-trigger slds-dropdown-trigger_click"
          >
            <Menu>
              <MenuButton
              ...
              <MenuItems class="slds-dropdown slds-dropdown_right">
                <ul
