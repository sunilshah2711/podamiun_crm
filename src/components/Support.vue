      ...
      <ul class="slds-chat-list">
        <li class="slds-chat-listitem slds-chat-listitem_bookend">
          <div class="slds-chat-bookend">
            ...
            <p>Chat started by <b>Andy Martinez</b> • 4:58 PM</p>
          </div>
        </li>
          ...
          <div class="slds-chat-message">
            ...
            <div class="slds-chat-message__body">
              ...
              <div
                ...
                aria-label="said Andy Martinez at 4:59 PM"
              >
        ...
        <li class="slds-chat-listitem slds-chat-listitem_outbound">
          <div class="slds-chat-message">
            <div class="slds-chat-message__body">
              ...
              >
                <span
                  >Hi Andy, thank you for contacting Widget Support. Can you
        ...
        <li class="slds-chat-listitem slds-chat-listitem_outbound">
          <div class="slds-chat-message">
            <div class="slds-chat-message__body">
              ...
              <div
                class="slds-chat-message__meta"
                aria-label="said Jason Dewar at 5:02 PM"
              >
                Jason Dewar • 5:02 PM
              </div>
            </div>
        ...
        <li class="slds-chat-listitem slds-chat-listitem_inbound">
          <div class="slds-chat-message">
            ...
            <div class="slds-chat-message__body">
              ...
              <div
                class="slds-chat-message__meta"
                aria-label="said Andy Martinez at 5:09 PM"
              >
            ...
            <div class="slds-chat-message__body">
              ...
              >
                <span
                  ...
                  support member. Thank you for your patience!</span
                >
              </div>
              <div
                class="slds-chat-message__meta"
                aria-label="said Jason Dewar at 5:15 PM"
              >
                Jason Dewar • 5:15 PM
              </div>
            </div>
        ...
        <li class="slds-chat-listitem slds-chat-listitem_event">
          <div class="slds-chat-event">
            <div class="slds-chat-event__body">
              <span
                class="slds-icon_container slds-icon-utility-change_owner slds-chat-icon"
              >
                <svg
                  class="slds-icon slds-icon_x-small slds-icon-text-default"
                  aria-hidden="true"
                >
                  <use
                    xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#change_owner"
                  ></use>
                </svg>
              </span>
              <p>
                <b>Jason Dewar</b> sent a transfer request to
                <b>Technical Support Team</b> • 5:19 PM
              </p>
            </div>
        ...
        <li class="slds-chat-listitem slds-chat-listitem_event">
          <div class="slds-chat-event">
            <div class="slds-chat-event__body">
              ...
              <p><b>Amber Cann</b> accepted this chat • 5:22 PM</p>
            </div>
          </div>
        </li>
        <li class="slds-chat-listitem slds-chat-listitem_outbound">
          <div class="slds-chat-message">
            <div class="slds-chat-message__body">
              ...
              >
                <span
                  >Hi Andy, my name is Amber and I can help you solve your
                  issue.</span
                >
              </div>
              <div
        ...
        <li class="slds-chat-listitem slds-chat-listitem_bookend">
          <div class="slds-chat-bookend slds-chat-bookend_stop">
            <span
              class="slds-icon_container slds-icon-utility-end_chat slds-chat-icon"
            >
              <svg
                class="slds-icon slds-icon_x-small slds-icon-text-default"
                aria-hidden="true"
              >
                <use
                  xlink:href="/assets/icons/utility-sprite/svg/symbols.svg#end_chat"
                ></use>
              </svg>
            </span>
            <p>Chat ended by <b>Andy Martinez</b> • 5:30 PM</p>
          </div>
        </li>
      </ul>
    </section>
